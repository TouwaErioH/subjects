...
BEGIN_MESSAGE_MAP(CHookWindowDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_GetDesk, &CHookWindowDlg::OnBnClickedButtonGetDesk)
...
void CHookWindowDlg::OnBnClickedButtonGetDesk()
{
	// TODO: 在此添加控件通知处理程序代码
	MessageBoxW(_T("这是正常的GetDesktopWindow..."), _T("呵呵"), 0);
}
